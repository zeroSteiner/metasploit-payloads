...
namespace MSF.Powershell.Meterpreter
{
    public static class Sys
    {
        ...
        public static SysInfo Info()
        {
            ...
            var result = Core.InvokeMeterpreterBinding(true, tlv.ToRequest(PacketMethod.StdapiSysConfigSysinfo));
        ...
        public static List<ProcessInfo> ProcessList()
        {
            ...
            var result = Core.InvokeMeterpreterBinding(true, tlv.ToRequest(PacketMethod.StdapiSysProcessGetProcesses));
