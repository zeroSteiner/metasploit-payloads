...
namespace MSF.Powershell.Meterpreter
{
    public static class Incognito
    {
        ...
        public static bool AddUser(string server, string username, string password)
        {
            ...
            var result = Core.InvokeMeterpreterBinding(true, tlv.ToRequest(PacketMethod.IncognitoAddUser));
        ...
        {
            return AddGroupUserInternal(PacketMethod.IncognitoAddGroupUser, server, group, username);
        }
        
        public static bool AddLocalGroupUser(string server, string group, string username)
        {
            return AddGroupUserInternal(PacketMethod.IncognitoAddLocalgroupUser, server, group, username);
        }
        
        private static bool AddGroupUserInternal(PacketMethod method, string server, string group, string username)
        {
            ...
            var result = Core.InvokeMeterpreterBinding(true, tlv.ToRequest(method));
        ...
        public static bool SnarfHashes()
        {
            ...
            var result = Core.InvokeMeterpreterBinding(true, tlv.ToRequest(PacketMethod.IncognitoSnarfHashes));
        ...
        public static bool Impersonate(string user)
        {
            ...
            var result = Core.InvokeMeterpreterBinding(true, tlv.ToRequest(PacketMethod.IncognitoImpersonateToken));
        ...
        public static TokenSet ListTokens(TokenType type)
        {
            ...
            var result = Core.InvokeMeterpreterBinding(true, tlv.ToRequest(PacketMethod.IncognitoListTokens));
