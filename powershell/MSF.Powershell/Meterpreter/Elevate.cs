...
namespace MSF.Powershell.Meterpreter
{
    public static class Elevate
    {
        public static bool GetSystem()
        {
            ...
            var result = Core.InvokeMeterpreterBinding(true, tlv.ToRequest(PacketMethod.PrivElevateGetsystem));
        ...
        public static bool Rev2Self()
        {
            ...
            var result = Core.InvokeMeterpreterBinding(true, tlv.ToRequest(PacketMethod.StdapiSysConfigRev2self));
        ...
        public static bool StealToken(int pid)
        {
            ...
            var result = Core.InvokeMeterpreterBinding(true, tlv.ToRequest(PacketMethod.StdapiSysConfigStealToken));
        ...
        public static bool DropToken()
        {
            ...
            var result = Core.InvokeMeterpreterBinding(true, tlv.ToRequest(PacketMethod.StdapiSysConfigDropToken));
