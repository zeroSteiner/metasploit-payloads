...
namespace MSF.Powershell.Meterpreter
{
    public static class Transport
    {
        ...
        public static SessionDefinition List()
        {
            ...
            var result = Core.InvokeMeterpreterBinding(true, tlv.ToRequest(PacketMethod.CoreTransportList));
        ...
        public static bool Add(TransportInstance transport, int sessionExpiry = 0)
        {
            ...
            var result = Core.InvokeMeterpreterBinding(true, tlv.ToRequest(PacketMethod.CoreTransportAdd));
